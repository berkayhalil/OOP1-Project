        ...
        if (file.exists() && file.isFile()) {
            try {
                ...
                if (element != null) {
                    ...
                    System.out.println("Елемент с ID " + elementId + ":");
                    System.out.println(elementToString(element));
                } else {
                    System.out.println("Не е намерен елемент с ID " + elementId);
                }
            } catch (Exception e) {
                System.out.println("Грешка при извличане на елемента: " + e.getMessage());
            }
        } else {
